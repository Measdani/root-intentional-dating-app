      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mx-auto mt-16 grid max-w-4xl gap-8 lg:grid-cols-[1fr_.85fr]">
          ...
          <section className="rounded-[30px] border border-[#D9FF3D]/20 bg-[#111611] p-7 sm:p-8">
            ...
            <h2 className="mt-6 font-display text-3xl">Founding access</h2>
            <p className="mt-3 text-sm leading-6 text-[#A9B5AA]">Create your private learning account to begin. Secure lifetime-access checkout can be connected when pricing is finalized.</p>
            <button type="button" onClick={() => setCurrentView('create-account')} className="mt-8 w-full rounded-full bg-[#D9FF3D] px-5 py-3.5 text-sm font-semibold text-[#0B0F0C]">Create my account</button>
