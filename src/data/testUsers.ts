export const testUsers = [
  ...
  },
  {
    ...
    city: 'Austin, TX',
    gender: 'male' as const,
    partnershipIntent: 'casual' as const,
    familyAlignment: {
      hasChildren: false,
      wantsChildren: 'unsure' as const,
      openToPartnerWithParent: 'not-open' as const,
    },
    values: ['Adventure', 'Independence', 'Fun', 'Travel', 'Spontaneity'],
    growthFocus: 'Understanding commitment and deeper emotional connections',
    relationshipVision: 'Exploring what a meaningful partnership could look like.',
    communicationStyle: 'Casual and sometimes avoidant. Works on being more present and vulnerable.',
    bio: 'Software developer who loves outdoor activities. Still figuring out what I want in a relationship.',
    alignmentScore: 62,
