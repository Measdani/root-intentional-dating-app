...
export const growthModuleContent: Record<string, ModuleContent> = {
  'g1-m1': {
  ...
  'g3-m1': {
    ...
    keyPoints: [
      ...
      'A strong sense of self is not selfish - it is the foundation for healthy partnership.',
    ],
    exercise: [
  ...
  'g5-m4': {
    ...
    exercise: [
      'Identify your flooding signs: What happens physically? What is your limit?',
