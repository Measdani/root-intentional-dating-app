...
export const sampleUsers: User[] = [
  ...
  },
  {
    ...
    values: ['Integrity', 'Growth', 'Family', 'Calm', 'Respect'],
    growthFocus: 'Sustaining emotional consistency',
    relationshipVision: 'A grounded, faith-forward partnership built on consistency, repair, and shared purpose.',
    communicationStyle: 'Clear and direct. Prioritizes listening and emotional accountability.',
    bio: 'Operations leader who values emotional maturity and intentional commitment.',
    alignmentScore: 92,
    photoUrl: 'https://i.pravatar.cc/300?u=ethan&img=12',
    membershipTier: 'annual',
    poolId: 'core-advanced',
  ...
  },
  {
    ...
    values: ['Loyalty', 'Kindness', 'Stability', 'Depth', 'Humor'],
    growthFocus: 'Leading with empathy in conflict',
    relationshipVision: 'A partnership where emotional safety, playfulness, and long-term loyalty coexist.',
    communicationStyle: 'Warm, steady, and collaborative. Values hard conversations done well.',
    bio: 'Product manager who believes healthy love is built through consistency, not intensity.',
    alignmentScore: 90,
    photoUrl: 'https://i.pravatar.cc/300?u=noah&img=13',
    membershipTier: 'quarterly',
    poolId: 'core-advanced',
  ...
  },
  {
    ...
    values: ['Honesty', 'Faith', 'Growth', 'Joy', 'Loyalty'],
    growthFocus: 'Balancing softness with boundaries',
    relationshipVision: 'A deeply aligned marriage with emotional safety, shared values, and long-term vision.',
    communicationStyle: 'Direct with warmth. Prefers clarity early and repair over avoidance.',
    bio: 'Healthcare professional who values faith, consistency, and intentional partnership.',
    alignmentScore: 93,
    photoUrl: 'https://i.pravatar.cc/300?u=leah&img=14',
    membershipTier: 'annual',
    poolId: 'core-advanced',
  ...
  },
  {
    ...
    values: ['Compassion', 'Integrity', 'Family', 'Resilience', 'Depth'],
    growthFocus: 'Protecting peace while staying connected',
    relationshipVision: 'A resilient partnership rooted in trust, co-leadership, and emotional maturity.',
    communicationStyle: 'Calm, reflective, and solution-focused. Values steady follow-through.',
    bio: 'Educator and mother who is intentional about building a peaceful and durable partnership.',
    alignmentScore: 91,
    photoUrl: 'https://i.pravatar.cc/300?u=hannah&img=15',
    membershipTier: 'quarterly',
    poolId: 'core-advanced',
