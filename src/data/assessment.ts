...
export const membershipTiers: MembershipTier[] = [
  {
    ...
    price: '$29',
    period: '/month',
    bestFor: 'Exploring intentionally',
    features: [
  ...
  },
  {
    ...
    period: '/quarter',
    badge: 'Save 20%',
    bestFor: 'Consistent growth and clarity',
    features: [
      'Everything in Monthly',
      'Priority support',
      'Exclusive Mode access (focused 1:1 connection)',
      'Deeper access to Forest AI insights',
    ],
  },
  {
    id: 'annual',
